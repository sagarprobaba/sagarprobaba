...
(function ($) {
    ...
    function write_review_seller() {
        $(".write-review-btn-seller").on("click", function (e) {
            $('.write-review-btn-seller').toggleClass('active');
            $(".product-review-form-seller").slideToggle();
            e.preventDefault();
        });
    }
    write_review_seller();
