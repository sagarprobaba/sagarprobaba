class MessageBox {
  ...
  show(title, msg, label = "CLOSE", callback = null) {
    ...
    let msgboxBoxContent = document.createElement("DIV");
    let msgboxHead = document.createElement("DIV");
    ...
    // heading area of the message box
    msgboxHead.classList.add("msgbox-head");
    msgboxHead.innerText = title;
    ...
    msgboxBoxContent.classList.add("msgbox-box-content");
    msgboxBoxContent.appendChild(msgboxContent);
    ...
    if (option.hideCloseButton === false
      ...
      msgboxBoxContent.appendChild(msgboxClose);
    }

    msgboxBox.classList.add("msgbox-box");
    msgboxBox.appendChild(msgboxHead);
    msgboxBox.appendChild(msgboxBoxContent);
