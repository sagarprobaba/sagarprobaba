						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									...
									@foreach ($item->user_enquiry_send as $enquiry)
									<div class="col-md-12">
										<h5>#{{ $loop->iteration }} Enquiry</h5>
										<table class="table table-striped table-hovered">
											<tr>
												<td>Business Profile:</td>
												<td>
													@if($enquiry->user)
													<a href="{{ route('vendor.details',$enquiry->user->slug) }}">{{$enquiry->user->name}}</a>
													@endif
												</td>
											</tr>
											<tr>
									...
									@if ($item->enquiry_lawyer_send->isEmpty())
									<div class="col-md-12">
