...
@section('add_link',route('flitchedType.store'))
@section('container')

{!! Form::open(['route' => ['flitchedType.store'],'method' => 'post', 'novalidate' => 'novalidate', 'enctype' => 'multipart/form-data',]) !!}

	<section class="top-bredcumb">
		<div class="row">
			<div class="col-lg-3">
				<h4>Features Types</h4>
			</div>
			<div class="col-lg-6">				
				<ul class="breadcrumb">
