...
@section('page_title','Features Types ')

@section('page_heading','Features Types ')
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">
					<a class="btn btn-primary btn-xs" href="{{url('/admin/flitchedType/'.$item->id.'/edit')}}">
						<i class="fa fa-pencil"> Edit </i>
					</a>
					<form action="{{url('/admin/flitchedType/'.$item->id)}}" method="post" style="display:inline-block">
