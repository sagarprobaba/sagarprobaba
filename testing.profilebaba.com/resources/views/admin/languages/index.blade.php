	...
	<table class="table table-striped table-hover table-bordered" id="editable-sample">
		<thead>
			<tr>
				...
				<th class="text-center">Languages Name</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">
					<a class="btn btn-primary btn-xs" href="{{url('/admin/languages/'.$item->langid.'/edit')}}">
						<i class="fa fa-pencil"> Edit </i>
					</a>
					<form action="{{url('/admin/languages/'.$item->langid)}}" method="post" style="display:inline-block">
