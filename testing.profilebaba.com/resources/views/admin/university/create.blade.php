...
@endif
 <form action="{{url('/admin/university/')}}"  method="post" accept-charset="utf-8">
 <section class="top-bredcumb">
	...
	<div class="row">
		...
		<div class="col-lg-9">
			<section class="panel">
				<header class="panel-heading">University Details</header>
				<div class="panel-body">
					<div class="form-group">
						<input type="text" name="title"  class="form-control" placeholder="University Name">
					</div>
				</div>
			</section>
		</div>
