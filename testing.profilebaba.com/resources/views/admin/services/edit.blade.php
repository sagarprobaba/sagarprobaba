...
@endif
<form action="{{url('/admin/services/'.$item->serid)}}" name="frm_add_courttype" id="frm_add_courttype" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
    {{ method_field('PUT')}}  
        ...
        <section class="panel">
            <div class="panel-body">
                ...
                <div class="form-group" style="display: none;">
                    <input type="text" name="slug"  class="form-control" placeholder="Slug" value="{{$item->slug}}">
                </div>                
