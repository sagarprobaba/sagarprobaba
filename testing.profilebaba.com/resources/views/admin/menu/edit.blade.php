...
@endif
<form action="{{url('/admin/menu/'.$item->id)}}" name="frm_add_menu" id="frm_add_menu" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
	{{ method_field('PUT')}} 
			...
			<section class="panel">
                ...
                <div class="form-group">
                            <label for="text">Name</label>
                             <input type="text" required="" class="form-control item-menu" name="name" id="name" value="{{$item->name}}" placeholder="Title">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="position">
                                ...
                                <option value="header" {{$item->position == "header" ? 'selected' :''}}>Header</option>
                                <option value="footer" {{$item->position == "footer" ? 'selected' :''}}>Footer</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="need_login">
                                ...
                                <option value="1" {{$item->need_login == '1' ? 'selected' :''}}>Yes</option>
                                <option value="0" {{$item->need_login == '0' ? 'selected' :''}}>No</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="msg" type="text" class="form-control item-menu ffffffff" id="href" name="href" placeholder="Enter URL" value="{{$item->href}}">
                            </div>
                        </div>
                </div>
            </section>
