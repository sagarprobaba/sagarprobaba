    ...
    <table class="table table-striped table-hover table-bordered" id="editable-sample">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-primary btn-xs" href="{{url('/admin/country/'.$item->coid.'/edit')}}"><i class="fa fa-pencil"> Edit </i></a>
                    <form action="{{url('/admin/country/'.$item->coid)}}" method="post" style="display: inline-block;">
