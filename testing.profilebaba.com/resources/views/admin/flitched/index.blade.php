...
@section('add_link',route('admin_flitched_create'))
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">
					<a class="btn btn-primary btn-xs" href="{{url('/admin/flitched/'.$item->id.'/edit')}}">
						<i class="fa fa-pencil"> Edit </i>
					</a>
					<form action="{{url('/admin/flitched/'.$item->id)}}" method="post" style="display:inline-block">
