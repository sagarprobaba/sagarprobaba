                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <div class="flex-grow-1">
                            <a href="{{route('addressVerify.index')}}" rel="noopener noreferrer"> <button class="btn btn-info add-btn">Form List</button></a>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="text" name="candidateName" class="form-control bg-light border-0" id="invoicenoInput" value="{{old('candidateName')}}">
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4 col-sm-6">
                                        <div>
                                            <label for="date-field">Check id</label>
                                            <input type="text" name="checkId" class="form-control bg-light border-0" id="date-field" data-provider="flatpickr" data-time="true" value="{{old('checkId')}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="text" name="periodOfStay" class="form-control bg-light border-0" id="invoicenoInput" placeholder="" value="{{old('periodOfStay')}}">
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4 col-sm-6">
                                        <div>
                                            <label for="date-field">Document Proof Attached</label>
                                            <input type="text" name="documentProofAttached" class="form-control bg-light border-0" id="date-field" data-provider="flatpickr" data-time="true" value="{{old('documentProofAttached')}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4 col-sm-6">
                                        <label for="invoicenoInput">Respondent’s Name</label>
                                        <input type="text" name="respondentName" class="form-control bg-light border-0" id="invoicenoInput" placeholder="" value="{{old('respondentName')}}">
                                    </div>
                                    <!--end col-->
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-4 col-sm-6">
                                        <div>
                                            ...
                                            <input type="text" name="respondentContactDetails" class="form-control bg-light border-0" id="date-field" data-provider="flatpickr" data-time="true" value="{{old('respondentContactDetails')}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="input-light">
                                            <input type="text" name="respondentSignature" class="form-control bg-light border-0" id="date-field" data-provider="flatpickr" data-time="true" value="{{old('respondentSignature')}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4 col-sm-6">
                                        <label for="invoicenoInput">Additional Comment if any</label>
                                        <input type="text" name="additionalComment" class="form-control bg-light border-0" id="invoicenoInput" value="{{old('additionalComment')}}">
                                    </div>
                                    <!--end col-->
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-4 col-sm-6">
                                        <div>
                                            ...
                                            <input type="date" name="dateOfVisit" class="form-control bg-light border-0" id="date-field" data-provider="flatpickr" data-time="true" value="{{old('dateOfVisit')}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
