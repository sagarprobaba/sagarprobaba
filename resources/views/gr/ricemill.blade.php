                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="flex-grow-1">
                                                <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-fill me-1 align-bottom"></i> Add Rice Mills</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div>
                                                            ...
                                                            <input minlength="10" maxlength="10" class="form-control" id="emailID" placeholder="Enter" name="MobileNo" required onkeypress="return isNumber(event);" type="text" ondrop="return false;" onpaste="return false;" required>
                                                        </div>
                                                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        <h4 class="fs-semibold">You are about to delete a Rice Mill ?</h4>
                                        <p class="text-muted fs-14 mb-4 pt-1">Deleting your Rice Mill will
