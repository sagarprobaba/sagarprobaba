                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-auto ms-auto">
                                    <div class="flex-grow-1">
                                        <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="ri-add-fill me-1 align-bottom"></i> Add Master</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-medium" style="text-align:center">{{$data->MasterHead}}</td>
                                                <td style="text-align:center">
                                                    <div class="team-profile-img">
                                                        <center>
                                                        <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0" style="width: 40px;height: 40px;">
                                                            <img src="{{asset('storage/app/public/document/'.$data->MasterIcon)}}" alt="" class="img-fluid d-block rounded-circle" style="width:100px">
                                                        </div>
                                                        </center>
                                                    </div>
                                                </td>
                                                ...
                                                <td style="text-align:center;width:8%">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0 ml-2">
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{$data->status==1?'Enable':'Desable'}}">
                                                            <a href="{{url('master_desable/'.$data->id)}}" class="text-muted d-inline-block">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                            <a class="remove-item-btn" href="{{url('master_delete/'.$data->id)}}">
