                        ...
                        <div class="card-header">
                            <form action="{{url('filtEnquiry')}}" method="get">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        <label for="confirmPassword" class="form-label">Sub Category</label>
                                        <select class="form-select " name="subcategory" id="serchSubcategory" aria-label="Default select example">
                                            <option value="">Select</option>
                                            @if(isset($subcatelist))
                                            @foreach($subcatelist as $subcateli)
                                            <option value="{{$subcateli->id}}">{{$subcateli->category_name}}</option>
                                            @endforeach
                                            @endif

                                        </select>
                                        <script>
                                            document.getElementById('serchSubcategory').value = "{{isset($serchSubcategory)?$serchSubcategory:''}}";
                                        </script>
                                    </div>
                                    <div class="col-md-3">
                                        <button type="submit" class="btn btn-info mt-4">Search</button>
                                        <a href="{{url('adenquiry')}}"><button type="button" class="btn btn-info mt-4">Clear</button></a>
                                    ...
                                    <div class="col-sm-auto ms-auto">
                                        <button type="button" class="btn btn-info add-btn"><a href="{{url('auctionlist')}}" target="_blank">Auction List</a></button>
                                    ...
                                    <table class="table table-bordered align-middle mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center">Ad Category</th>
                                                <th scope="col" style="text-align:center">Advertise</th>
                                                ...
                                                <th scope="col" style="text-align:center">Assined Vendors</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                $ad = Cpr_Add_post::find($data->ad_id);
                                                $cat =  Cpr_ad_mapped_category::where('ad_id', $data->ad_id)->first(['category_id']);
                                                if (isset($cat->category_id)) {
                                                    $adcat1 = Cpr_ad_category::find($cat->category_id);
                                                    $adcat = $adcat1?->category_name;
                                                } elseif(isset($data->main_cat))
                                                {
                                                     $adcat1 = Cpr_ad_category::find($data->main_cat);
                                                    $adcat = $adcat1?->category_name;
                                                }
                                                else {
                                                    $adcat = '';
                                                ...
                                                ?>
                                                <td class="fw-medium" style="text-align:center">{{$adcat}}</td>
                                                <td class="fw-medium" style="text-align:center">
                                                ...
                                                <td class="fw-medium" style="text-align:center">{{$data->phone}}</td>
                                                <td class="fw-medium" style="text-align:center">₹{{$data->subject}}</td>
                                                <td class="fw-medium" style="text-align:center">{{$data->message}}</td>
                                                <?php
                                                $cnt = Cpr_enquiry_assign::where('cpr_ad_enquiry_id', $data->id)->count();
                                                ?>
                                                <td class="fw-medium" style="text-align:center">
                                                    <a href="javascript:void(0)" data-bs-toggle="modal" onclick="getVendorList({{$data->id}})" data-bs-target="#showVendorList">{{$cnt}}</a>
                                                ...
                                                <td style="text-align:center;width:8%">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0 ml-2">
                                                        ...
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Enable">
                                                            <a href="{{url('enquiry_enable/'.$data->id)}}" class="text-muted d-inline-block">
                                                        ...
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Disable">
                                                            <a href="{{url('enquiry_disable/'.$data->id)}}" class="text-muted d-inline-block">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                            <a class="remove-item-btn" href="{{url('enquiry_delete/'.$data->id)}}" onclick="return confirm('Are You Sure?')">
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
                <div class="step-arrow-nav">
                    <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link p-3 active" id="pills-bill-info-tab" data-bs-toggle="pill" data-bs-target="#pills-bill-info" type="button" role="tab" aria-controls="pills-bill-info" aria-selected="true">Assign Vendor List</button>
                        </li>
                            ...
                            <table class="table table-bordered align-middle  mb-0" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th align="center" scope="col">Contact</th>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="pills-bill-info" role="tabpanel" aria-labelledby="pills-bill-info-tab">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <label for="confirmPassword" class="form-label">Min Increment Amount</label>          
                                        <input type="text" class="form-control" name="Min_increment_amt" value="" required>                              
                                    </div>
                                </div>                   
                                <div class="col-lg-4">
                                    <div>
