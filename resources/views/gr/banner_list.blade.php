                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-auto ms-auto">
                                    <div class="flex-grow-1">
                                        <a href="{{route('Banner.create')}}"><button class="btn btn-info add-btn"><i class="ri-add-fill me-1 align-bottom"></i> Add Banner</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered align-middle table-nowrap mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center">slider_short</th>                                                
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-medium" style="text-align:center">{{$data->position}}</td>
                                                <td style="text-align:center">
                                                    <div class="team-profile-img">
                                                        <center>
                                                        
                                                            <img src="{{asset('public/banner/'.$data->banner)}}" alt="" class="img-fluid d-block" style="width:150px;">
                                                        
                                                        </center>
                                                    </div>
                                                </td>
                                                <td class="fw-medium" style="text-align:center">{{$data->link}}</td>
                                                <td class="fw-medium" style="text-align:center">{{$data->heading}}</td>
                                                <td class="fw-medium" style="text-align:center">{{$data->description}}</td>
                                                <td class="fw-medium" style="text-align:center">{{$data->slider_short}}</td>
                                                ...
                                                <td style="text-align:center;width:8%">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0 ml-2">
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{$data->status==1?'Disable':'Enable'}}">
                                                           @if($data->status == 1)
                                                            <a href="{{url('banner_disable/'.$data->id)}}" class="text-muted d-inline-block">
                                                                <i class="ri-check-fill fs-16" style="color:red;font-weight: bold;"></i>
                                                            </a>
                                                            @else
                                                            <a href="{{url('banner_enable/'.$data->id)}}" class="text-muted d-inline-block">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a class="edit-item-btn" href="{{route('Banner.edit',$data->id)}}"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                        </li>
                                                        @if(auth()->user()->delete_access == 1)
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                            <a class="remove-item-btn" href="{{url('banner_delete/'.$data->id)}}" onclick="return confirm('Are You Sure?')">
