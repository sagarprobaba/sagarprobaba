                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-auto ms-auto">
                                    <div class="flex-grow-1">
                                        <a href="{{route('Pages.create')}}"><button class="btn btn-info add-btn"><i class="ri-add-fill me-1 align-bottom"></i> Add Pages</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered align-middle table-nowrap mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center">Page Banner</th>
                                                <th scope="col" style="text-align:center">Page Url</th>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <div class="team-profile-img">
                                                        <center>
                                                            @if(isset($data->image))
                                                            <img src="{{asset('public/footer/'.$data->image)}}" alt="" class="img-fluid d-block" style="width:100px;">
                                                            @endif
                                                        </center>
                                                    </div>
                                                </td>
                                                <td class="fw-medium" style="text-align:center"><a rel="stylesheet" href="http://profilebaba.com/page/{{$data->slug}}" target="_blank">http://profilebaba.com/page/{{$data->slug}}</a></td>
                                                ...
                                                <td style="text-align:center;width:8%">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0 ml-2">
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{$data->status==1?'Disable':'Enable'}}">
                                                            @if($data->status == 1)
                                                            <a href="{{url('pages_disable/'.$data->id)}}" class="text-muted d-inline-block">
                                                                <i class="ri-check-fill fs-16" style="color:red;font-weight: bold;"></i>
                                                            </a>
                                                            @else
                                                            <a href="{{url('pages_enable/'.$data->id)}}" class="text-muted d-inline-block">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a class="edit-item-btn" href="{{route('Pages.edit',$data->id)}}"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                        </li>
                                                        @if(auth()->user()->delete_access == 1)
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                            <a class="remove-item-btn" href="{{url('pages_delete/'.$data->id)}}" onclick="return confirm('Are You Sure?')">
