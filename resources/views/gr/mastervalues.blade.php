                                    ...
                                    <table class="table table-bordered align-middle table-nowrap mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center">Master</th>
                                                <th scope="col" style="text-align:center">Master Value</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $head = Master::where('id',$data->MasterHead)->first();
                                            ?>
                                            <tr>
                                                <td class="fw-medium" style="text-align:center">{{$loop->index+1}}</td>
                                                <td class="fw-medium" style="text-align:center">{{$head->MasterHead}}</td>
                                                <td class="fw-medium" style="text-align:center">{{$data->MasterValue}}</td>
                                                ...
                                                <td style="text-align:center">
                                                    <div class="team-profile-img">
                                                        ...
                                                        <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0" style="width: 40px;height: 40px;">
                                                            ...
                                                            @if(isset($data->MasterValueIcon))
                                                            <img src="{{asset('storage/app/public/document/'.$data->MasterValueIcon)}}" alt="" class="img-fluid d-block rounded-circle" style="width:100px">
                                                            @else
                                                            <img src="{{asset('assets/images/no.png')}}" alt="" class="img-fluid d-block rounded-circle" style="width:100px">
                                                            @endif
                                                        </div>
                                                        </center>
                                                    </div>
                                                ...
                                                <td style="text-align:center;width:8%">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0 ml-2">
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{$data->status==1?'Enable':'Desable'}}">
                                                            <a href="{{url('masterValue_desable/'.$data->id)}}" class="text-muted d-inline-block">
                                                                <i class="ri-check-fill fs-16" style="color:{{$data->status==1?'green':'red'}};font-weight: bold;"></i>
                                                            </a>
                                                        </li>

                                                        <li class="list-inline-item">
                                                            <a class="edit-item-btn" href="javascript:void(0)" onclick="editmastervalue({{$data->id}})" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                        </li>
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                            <a class="remove-item-btn" href="{{url('masterValue_delete/'.$data->id)}}">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <!--end modal-body-->
            <form action="{{route('MasterValue.store')}}" method="POST" class="checkout-tab" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <select class="form-select" id="MasterHead" name="MasterHead" aria-label="Default select example" required>
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <input type="text" name="MasterValue" class="form-control" id="MasterValue" required>
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <label for="emailID" class="form-label">Master Value Icon</label>
                                        <input type="file" class="form-control" name="MasterValueIcon" id="emailID" accept="image/*">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
