                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-sm-auto ms-auto">
                                            <div class="flex-grow-1">
                                               <a href="{{route('companyVerify.index')}}"  rel="noopener noreferrer"> <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-fill me-1 align-bottom"></i> Add Form</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <p class="text-muted mb-0">Company Verification</p>
                                                        </td>
                                                        <td class="name">
                                                            <p class="text-muted mb-0"> Extra Fields <br>                                                               
                                                                
                                                                <?php
                                                                $al1 = companyLowerTable::where('Uperid', $data->id)->get();
                                                                $count = sizeof($al1);
                                                                ?>
                                                                @if($count > 0)
                                                                @foreach($al1 as $exf)
