        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Ad Category</h4>

                    <div class="page-title-right">
                        <div class="flex-grow-1">
                            <a href="{{route('Category.index')}}" rel="noopener noreferrer"> <button class="btn btn-info add-btn">Category List</button></a>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <input type="hidden" name="back" class="form-control bg-light " id="invoicenoInput" value="{{isset($back)?$back:''}}">
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6 col-sm-6">
                                            <div>
                                                <label for="date-field">Meta Keyword</label>
                                                <input type="text" name="category_slug" class="form-control bg-light " id="date-field" data-provider="flatpickr" data-time="true" value="{{isset($item)?$item->category_slug:''}}">
                                            </div>
                                        </div>
                                        <!--end col-->
