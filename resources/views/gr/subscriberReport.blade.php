...
<div class="page-content">
    ...
    @endif
                                ...
                                <a href="{{url('subReport')}}"><button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#showModal">
                                    ...
                                    <table class="table table-bordered align-middle mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center">CAC Certificate/Number</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <img src="{{asset('public/user/'.$data->companyLogo)}}" class="img-fluid d-block rounded-circle" alt="profile" width="50" style="height:45px" />

                                                @elseif(isset($data->image))
                                                <img src="{{asset('public/user/'.$data->image)}}" class="img-fluid d-block rounded-circle" alt="profile" width="50" style="height:45px" />

                                                @else
                                                <img src="webassets/images/profile.png" alt="profile" class="img-fluid d-block rounded-circle" width="50" style="height:45px" />

                                                @endif</td>
                                                <td class="fw-medium" style="text-align:left">
                                                ...
                                                <td class="fw-medium" style="text-align:center">{{$data->plan}}</td>
                                                <td class="fw-medium" style="text-align:center">
                                                                @if(isset($data->cac_certificate))
                                                                <p class="text-muted mb-0"><a href="{{asset('public/user/'.$data->cac_certificate)}}" target="_blank" rel="noopener noreferrer"><i class='bx bx-file' style="font-size: 25px;"></i></a></p>
                                                                @endif
                                                                {{$data->cac_certificate_number}}
                                                </td>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <form action="{{url('subFilter')}}" class="d-flex flex-column justify-content-end h-100">
        @csrf
        <div class="offcanvas-body">
            <div class="mb-3">
                <div class="col-lg-12">
                    <div>
                        <label for="serviceTax" class="form-label">Subscription type</label>
            ...
            <!-- <div class="mb-3">
                <div class="col-lg-12">
                    <div>
                        <label for="serviceTax" class="form-label">Amount</label>
            ...
            <div class="mb-3">
                <div class="col-lg-12">
                    <div>
                        ...
                        <input type="date" class="form-control" name="todate" id="" value="{{isset($todate)?$todate:''}}">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                <div class="col-lg-12">
                    <div>
                        ...
                        <input type="date" class="form-control" name="fromdate" id="" value="{{isset($fromdate)?$fromdate:''}}">
                    </div>
                </div>
            </div>
            <div class="mb-3">
                <div class="col-lg-12">
                    <div>
                        <label for="serviceTax" class="form-label">Subscription Expiring in</label>
        ...
        <div class="offcanvas-footer border-top p-3 text-center hstack gap-2">
            <a href="{{url('subReport')}}"><button type="button" class="btn btn-light w-100">Clear Filter</button></a>
