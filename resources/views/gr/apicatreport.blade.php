                                    ...
                                    <table class="table table-bordered align-middle mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col">Map to Other Category</th>                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($cat as $data)
                                            <tr>
                                                ...
                                                <td class="fw-medium">{{$data->api_cat}}</td>

                                                <td class="fw-medium">
                                               
                                                <select class="form-select bg-light " name="pcat" id="pcat{{$data->id}}" onchange="mapCategory(this.value,{{$data->id}})" aria-label="Default select example">
                                                    <option value="0">Select Category</option>
                                                    @foreach($pcat as $pc)
                                                    <option value="{{$pc->id}}"  @if (isset($data->map_cat_id)) {{$data->map_cat_id === $pc->id ? 'selected' : ''}} @endif >{{$pc->category_name}}</option>
                                                    @endforeach
                                                </select>
...
<script>
    ...
    function mapCategory(mcat,id) {
       
       jQuery.ajax({
       type: 'GET',
       url: "{{url('mapCategory')}}?id="+id+"&mcat="+mcat,
       dataType: 'html',
       success: function(data) {
