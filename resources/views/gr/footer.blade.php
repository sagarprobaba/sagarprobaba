            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Footer Category
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            @if(isset($item))
                            <form class="needs-validation" action="{{route('Footer.update',$item->id)}}" method="POST" enctype="multipart/form-data">
                                @method('PATCH')
                                @else
                                <form class="needs-validation" action="{{route('Footer.store')}}" method="POST" enctype="multipart/form-data">
                                    @endif
                                    @csrf
                                    <div class="row g-2">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <label for="invoicenoInput">Category Link*</label>
                                                ...
                                                <td align="right">
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{$data->status==1?'Desable':'Enable'}}">
                                                            @if($data->status==1)
                                                            <a href="{{url('Footer_disable/'.$data->id)}}" class="text-muted d-inline-block">
                                                                <i class="ri-check-fill fs-16" style="color:red;font-weight: bold;"></i>
                                                            </a>
                                                            @endif
                                                            @if($data->status==0)
                                                            <a href="{{url('Footer_enable/'.$data->id)}}" class="text-muted d-inline-block">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a class="edit-item-btn" href="{{route('Footer.edit',$data->id)}}" href="javascript:void(0)"><i class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                        </li>
                                                        @if(auth()->user()->delete_access == 1)
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                            <a class="remove-item-btn" href="{{url('Footer_delete/'.$data->id)}}" onclick="return confirm('Are You Sure')">
